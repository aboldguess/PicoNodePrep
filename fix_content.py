...
# We want to replace everything from `boot_py_content = """` down to `index_html_content = f"""`
...
text = re.sub(r'    boot_py_content = """[\s\S]*?    index_html_content = f"""', new_content, text)
